...
# イーサリアムアカウントの開設方法 {#how-to-create-an-ethereum-account}
...
## ステップ1：ウォレットを選ぶ {#step-1-choose-a-wallet}
...
## ステップ 2: ウォレットアプリをダウンロードしてインストールする {#step-2-download-and-install-your-wallet-app}

ウォレットを選んだら、ウォレットの公式サイトやアプリストアにアクセスして、ダウンロード、インストールしてください。 それらはすべて無料のはずです。

## ステップ 3: アプリを開いて、イーサリアムアカウントを開設する {#step-3-open-the-app-and-create-your-ethereum-account}
...
## ステップ 4: リカバリーフレーズを保存する {#step-4-store-your-recovery-phrase}
...
### イーサリアムのアカウントとウォレットは同じものですか? {#are-my-wallet-and-my-ethereum-account-the-same}
...
### ビットコインをイーサリアムのアドレスに送金したり、Etherをビットコインのアドレスに送金したりできますか? {#can-i-send-bitcoin-to-an-ethereum-address-or-ether-to-a-bitcoin-address}
...
### ETHのアドレスを所有している場合、他のブロックチェーンでもそれと同じアドレスが使えますか? {#if-i-own-an-eth-address-do-i-own-the-same-address-on-other-blockchains}
...
### 自分のウォレットを持つことは、取引所に資金を預けるよりも安全でしょうか？ {#is-having-my-own-wallet-safer-than-keeping-my-funds-on-an-exchange}
...
### 携帯電話/ハードウェアのウォレットを紛失した場合、失われた資金を復元させるために同じウォレットアプリを再度使用する必要はありますか? {#if-i-lose-my-phonehardware-wallet-do-i-need-to-use-the-same-wallet-app-again-to-recover-the-lost-funds}
