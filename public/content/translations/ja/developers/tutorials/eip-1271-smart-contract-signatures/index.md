...
## EIP-1271が必要な理由 {#why-does-eip-1271-exist}
...
## EIP-1271の仕組み {#how-does-eip-1271-work}
...
## EIP-1271実装の例: Safe {#example-eip-1271-implementation-safe}
...
## `_hash`パラメータとは正確には何ですか? およびメッセージ全体を渡さない理由 {#what-exactly-is-the-hash-parameter-why-not-pass-the-whole-message}
...
## EIP-1271を各自のコントラクトにどのように実装すべきか {#how-should-eip-1271-be-implemented-in-my-own-contracts}
