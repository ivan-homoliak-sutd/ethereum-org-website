...
# Jak stworzyć konto Ethereum {#how-to-create-an-ethereum-account}
...
## Krok 3: Otwórz aplikację i stwórz swoje konto Ethereum {#step-3-open-the-app-and-create-your-ethereum-account}
...
## Krok 4: Przechowuj swoją frazę odzyskiwania {#step-4-store-your-recovery-phrase}
...
### Czy mój portfel i moje konto Ethereum są tym samym? {#are-my-wallet-and-my-ethereum-account-the-same}
...
### Czy posiadanie własnego portfela jest bezpieczniejsze niż przechowywanie moich środków na giełdzie? {#is-having-my-own-wallet-safer-than-keeping-my-funds-on-an-exchange}
...
### Jeśli stracę swój telefon/portfel sprzętowy, czy muszę ponownie użyć tego samego portfela, aby odzyskać stracone środki? {#if-i-lose-my-phonehardware-wallet-do-i-need-to-use-the-same-wallet-app-again-to-recover-the-lost-funds}
