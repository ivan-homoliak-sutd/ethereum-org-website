...
## لماذا يوجد EIP-1271؟ {#why-does-eip-1271-exist}
...
## كيف يعمل EIP-1271؟ {#how-does-eip-1271-work}
...
## مثال على تنفيذ EIP-1271: Safe {#example-eip-1271-implementation-safe}
...
## ما هي معلمة `_hash` بالضبط؟ لماذا لا نمرر الرسالة بأكملها؟ {#what-exactly-is-the-hash-parameter-why-not-pass-the-whole-message}
...
### مواصفات EIP-1271 السابقة {#previous-eip-1271-specifications}
...
## كيف يجب تنفيذ EIP-1271 في عقودي الخاصة؟ {#how-should-eip-1271-be-implemented-in-my-own-contracts}
