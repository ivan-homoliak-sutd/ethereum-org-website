...
## Что такое архивный узел {#what-is-an-archive-node}
...
## Реализация и использование {#implementations-and-usage}
...
## Рекомендации по практическому применению {#recommended-practices}
