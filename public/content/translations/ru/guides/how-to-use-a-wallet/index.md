...
# Как использовать кошелек {#how-to-use-a-wallet}
...
## Откройте кошелек {#open-your-wallet}
...
### Могу я использовать один и тот же адрес на нескольких устройствах? {#can-i-use-the-same-address-on-multiple-devices}
...
### Мне не пришла криптовалюта, где можно проверить состояние транзакции? {#i-have-not-received-the-crypto-where-can-i-check-the-status-of-a-transaction}
...
### Могу ли я отменять транзакции или возвращать по ним средства? {#can-i-cancel-or-return-transactions}
