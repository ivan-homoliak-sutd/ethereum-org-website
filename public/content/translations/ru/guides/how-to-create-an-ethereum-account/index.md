...
# Как создать учетную запись Ethereum {#how-to-create-an-ethereum-account}
...
## Шаг 3: Откройте приложение и создайте учетную запись Ethereum {#step-3-open-the-app-and-create-your-ethereum-account}
...
## Шаг 4. Сохраните фразу для восстановления {#step-4-store-your-recovery-phrase}
...
### Мой кошелек и моя учетная запись Ethereum — это одно и то же? {#are-my-wallet-and-my-ethereum-account-the-same}
...
### Могу ли я отправлять биткоины на адрес Ethereum или эфиры на адрес Bitcoin? {#can-i-send-bitcoin-to-an-ethereum-address-or-ether-to-a-bitcoin-address}
...
### Если у меня есть адрес ETH, то принадлежит ли мне этот же адрес в других блокчейнах? {#if-i-own-an-eth-address-do-i-own-the-same-address-on-other-blockchains}
...
### Иметь собственный кошелек безопаснее, чем держать средства на бирже? {#is-having-my-own-wallet-safer-than-keeping-my-funds-on-an-exchange}
...
### Если я потеряю свой телефон / аппаратный кошелек, нужно ли мне снова использовать то же приложение кошелька, чтобы восстановить утерянные средства? {#if-i-lose-my-phonehardware-wallet-do-i-need-to-use-the-same-wallet-app-again-to-recover-the-lost-funds}
