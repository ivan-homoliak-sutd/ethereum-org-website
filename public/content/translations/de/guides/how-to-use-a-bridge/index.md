...
# Wie man Token auf Ebene 2 überbrückt {#how-to-bridge-tokens-to-layer-2}
...
## 1. Bestimmen Sie, welches Ebene-2-Netzwerk Sie verwenden möchten {#1-determine-which-layer-2-network-you-want-to-use}

Weitere Informationen zu den verschiedenen Projekten und wichtige Links finden Sie auf unserer [Ebene-2-Seite](/layer-2/).

## 2. Gehen Sie zur ausgewählten kettenübergreifenden Brücke {#2-go-to-the-selected-bridge}
...
## 3. Verbinden Sie Ihr Wallet mit der Brücke {#3-connect-to-the-bridge-with-your-wallet}
...
## 4. Geben Sie den Betrag an und verschieben Sie das Guthaben {#4-specify-the-amount-and-move-the-funds}
...
## 5. Bestätigen Sie die Transaktion in Ihrem Wallet {#5-confirm-the-transaction-in-your-wallet}
...
## 6. Warten Sie, bis Ihr Guthaben verschoben wurde {#6-wait-for-your-funds-to-be-moved}

Dieser Vorgang sollte nicht länger als 10 Minuten dauern.

## 7. Fügen Sie das ausgewählte Ebene-2-Netzwerk zu Ihrem Wallet hinzu (optional) {#7-add-the-selected-layer-2-network-to-your-wallet-optional}
...
### Kann ich zum Ethereum-Mainnet zurückkehren, nachdem ich meine Token auf Ebene 2 überbrückt habe? {#can-i-go-back-to-ethereum-mainnet-after-i-bridge-my-tokens-to-l2}
