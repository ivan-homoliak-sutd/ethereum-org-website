...
# Cómo pasar los tókenes a la capa 2 {#how-to-bridge-tokens-to-layer-2}
...
## 1. Determine la red de capa 2 que quiere usar {#1-determine-which-layer-2-network-you-want-to-use}

Puede obtener más información sobre los diferentes proyectos y enlaces importantes en nuestra [página de capa 2](/layer-2/).

## 2. Vaya al puente seleccionado {#2-go-to-the-selected-bridge}
...
## 3. Conéctese al puente con su cartera {#3-connect-to-the-bridge-with-your-wallet}
...
## 4. Especifique la cantidad y mueva los fondos {#4-specify-the-amount-and-move-the-funds}
...
## 5. Confirme la transacción en su cartera {#5-confirm-the-transaction-in-your-wallet}
...
## 6. Espere a que sus fondos se transfieran {#6-wait-for-your-funds-to-be-moved}

Este proceso no debería tardar más de 10 minutos.

## 7. Añada la red de la capa 2 seleccionada a su cartera (opcional) {#7-add-the-selected-layer-2-network-to-your-wallet-optional}
...
### ¿Qué pasa si tengo fondos en un intercambio? {#what-if-i-have-funds-on-an-exchange}
...
### ¿Puedo volver a la red principal de Ethereum después de conectar mis tókenes a L2? {#can-i-go-back-to-ethereum-mainnet-after-i-bridge-my-tokens-to-l2}
