...
# 암호화폐 자금에 대한 스마트 계약 액세스를 취소하는 방법 {#how-to-revoke-smart-contract-access-to-your-crypto-funds}
...
## 3단계: 취소하려는 스마트 계약 선택하기 {#step-3-select-a-smart-contract-you-wish-to-revoke}
...
## 4단계: 자금에 대한 접근 권한 취소하기 {#step-4-revoke-access-to-your-funds}
...
### 프로젝트에서 지갑 연결을 해제하는 것이 내 자금 사용 권한을 제거하는 것과 같나요? {#is-disconnecting-a-wallet-from-a-project-the-same-as-removing-permission-to-use-my-funds}

아니요, 프로젝트에서 지갑 연결을 해제하더라도 토큰 허용 권한을 부여한 상태라면 해당 토큰을 여전히 사용할 수 있습니다. 이 접근 권한을 취소해야 합니다.

### 계약 권한은 언제 만료되나요? {#when-will-the-contract-permission-expire}

계약 권한에는 만료일이 없습니다. 계약 권한을 부여하면 수년이 지난 후에도 사용될 수 있습니다.

### 프로젝트들이 무제한 토큰 허용을 설정하는 이유는 무엇인가요? {#why-do-projects-set-unlimited-token-allowance}
