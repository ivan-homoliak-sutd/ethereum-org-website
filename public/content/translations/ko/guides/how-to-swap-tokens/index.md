...
## 1. 선택한 탈중앙화 거래소(DEX) 에 지갑을 연결하세요. {#1-connect-your-wallet-to-the-decentralized-exchange-dex-of-your-choice}
...
## 2. 교환할 토큰 쌍을 선택하세요 {#2-select-the-pair-of-tokens-you-wish-to-swap}

예를 들어, 이더리움과 다이. 두 토큰 중 하나에 돈이 있는지 확인하세요.
![스왑을 위한 공용 인터페이스](./swap1.png)

## 3. 교환하고 싶은 토큰의 수량을 입력하고 교환 버튼을 클릭하세요 {#3-enter-the-amount-of-tokens-you-want-to-trade-and-click-swap}

거래소가 자동으로 몇 개의 토큰을 받을지 계산해 줍니다.

![스왑을 위한 공용 인터페이스](./swap2.png)

## 4. 거래 확인 {#4-confirm-the-transaction}

거래 내역을 확인하세요. 환율과 다른 수수료를 확인해서 나중에 불쾌한 일이 생기지 않도록 조심하세요.

![트랜잭션 검토를 위한 공용 인터페이스](./swap3.png)

## 5. 트랜잭션이 처리될 때까지 기다려 주세요 {#5-wait-for-the-transaction-to-be-processed}
