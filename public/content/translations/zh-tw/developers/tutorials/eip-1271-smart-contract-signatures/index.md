...
## EIP-1271 為何存在？ {#why-does-eip-1271-exist}
...
## EIP-1271 如何運作？ {#how-does-eip-1271-work}
...
## `_hash` 參數到底是什麼？ 為什麼不傳遞整個訊息？ {#what-exactly-is-the-hash-parameter-why-not-pass-the-whole-message}
...
### 先前的 EIP-1271 規範 {#previous-eip-1271-specifications}
...
## 應如何在自己的合約中實作 EIP-1271？ {#how-should-eip-1271-be-implemented-in-my-own-contracts}
