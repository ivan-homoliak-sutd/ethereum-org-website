...
# Come scambiare token {#how-to-swap-tokens}
...
## 1. Connetti il tuo portafoglio all'exchange decentralizzato (DEX) che preferisci {#1-connect-your-wallet-to-the-decentralized-exchange-dex-of-your-choice}
...
## 2. Seleziona la coppia di token che desideri scambiare {#2-select-the-pair-of-tokens-you-wish-to-swap}

Ad esempio, ETH e DAI. Assicurati di avere fondi in uno dei due token.
![Interfaccia comune per lo scambio](./swap1.png)

## 3. Inserisci la quantità di token che vuoi scambiare e clicca su scambia {#3-enter-the-amount-of-tokens-you-want-to-trade-and-click-swap}
...
### Posso scambiare ETH per BTC dal mio portafoglio? {#can-i-swap-eth-for-btc-from-my-wallet}
...
### Cos'è lo slippage? {#what-is-slippage}
