...
# మీ క్రిప్టో ఫండ్‌లకు స్మార్ట్ కాంట్రాక్ట్ యాక్సెస్‌ను ఎలా రద్దు చేయాలి {#how-to-revoke-smart-contract-access-to-your-crypto-funds}
...
## దశ 4: మీ నిధులకు యాక్సెస్‌ను రద్దు చేయండి {#step-4-revoke-access-to-your-funds}
...
### టోకెన్ యాక్సెస్‌ను రద్దు చేయడం వలన స్టేకింగ్, పూలింగ్, లెండింగ్ మొదలైనవి కూడా రద్దు చేయబడతాయా? {#does-revoking-token-access-also-terminate-staking-pooling-lending-etc}
...
### ఒక ప్రాజెక్ట్ నుండి వాలెట్‌ను డిస్‌కనెక్ట్ చేయడం నా నిధులను ఉపయోగించడానికి అనుమతిని తీసివేయడంతో సమానమా? {#is-disconnecting-a-wallet-from-a-project-the-same-as-removing-permission-to-use-my-funds}
...
### ప్రాజెక్ట్‌లు అపరిమిత టోకెన్ అలవెన్స్‌ను ఎందుకు సెట్ చేస్తాయి? {#why-do-projects-set-unlimited-token-allowance}
