...
# Як користуватися гаманцем {#how-to-use-a-wallet}
...
## Відкрийте гаманець {#open-your-wallet}
...
### Чи можна використовувати одну адресу на кількох пристроях? {#can-i-use-the-same-address-on-multiple-devices}
...
### Мені не прийшла криптовалюта. Де можна перевірити стан транзакції? {#i-have-not-received-the-crypto-where-can-i-check-the-status-of-a-transaction}
...
### Чи можна скасувати транзакції та повернути кошти? {#can-i-cancel-or-return-transactions}
