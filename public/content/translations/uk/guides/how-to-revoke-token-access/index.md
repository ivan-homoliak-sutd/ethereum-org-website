...
# Як анулювати доступ смарт-контракту до ваших криптовалютних ресурсів {#how-to-revoke-smart-contract-access-to-your-crypto-funds}
...
## Крок 1. Використовуйте інструменти для відкликання доступу {#step-1-use-revoke-access-tools}
...
## Крок 2. Під’єднайте свій гаманець {#step-2-connect-your-wallet}
...
## Крок 3. Виберіть смартконтракт, який ви хочете відкликати {#step-3-select-a-smart-contract-you-wish-to-revoke}
...
## Крок 4. Відкликайте доступ до своїх коштів {#step-4-revoke-access-to-your-funds}
...
### Чи відкликання доступу до токенів також припиняє стейкінг, об’єднання, кредитування тощо? {#does-revoking-token-access-also-terminate-staking-pooling-lending-etc}
...
### Чи від’єднання гаманця від проєкту — це те саме, що й видалення дозволу на використання моїх коштів? {#is-disconnecting-a-wallet-from-a-project-the-same-as-removing-permission-to-use-my-funds}
...
### Коли закінчується термін дії дозволу для контракту? {#when-will-the-contract-permission-expire}
...
### Чому проєкти встановлюють необмежений допуск до токенів? {#why-do-projects-set-unlimited-token-allowance}
