...
## Що таке архівна нода {#what-is-an-archive-node}
...
### Способи застосування {#use-cases}
...
## Реалізація та використання {#implementations-and-usage}
...
## Рекомендовані методи {#recommended-practices}
