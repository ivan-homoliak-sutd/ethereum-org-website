...
## Для чого потрібен EIP-1271? {#why-does-eip-1271-exist}
...
## Що саме являє собою параметр `_hash`? Чому б не передавати повідомлення повністю? {#what-exactly-is-the-hash-parameter-why-not-pass-the-whole-message}
...
## Як впроваджувати EIP-1271 у моїх власних контрактах? {#how-should-eip-1271-be-implemented-in-my-own-contracts}
