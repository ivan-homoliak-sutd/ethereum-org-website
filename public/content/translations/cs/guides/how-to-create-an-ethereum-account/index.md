...
# Jak vytvořit Ethereum účet {#how-to-create-an-ethereum-account}
...
## Krok 1: Zvolte si peněženku {#step-1-choose-a-wallet}
...
## Krok 4: Uložte si svou bezpečnostní frázi {#step-4-store-your-recovery-phrase}
...
### Jsou moje peněženka a můj Ethereum účet totéž? {#are-my-wallet-and-my-ethereum-account-the-same}
...
### Mohu poslat Bitcoin na adresu na Ethereu nebo Ether na Bitcoin adresu? {#can-i-send-bitcoin-to-an-ethereum-address-or-ether-to-a-bitcoin-address}
...
### Je vlastní peněženka bezpečnější než uchovávání finančních prostředků na burze? {#is-having-my-own-wallet-safer-than-keeping-my-funds-on-an-exchange}
...
### Pokud ztratím telefon/hardwarovou peněženku, musím pro obnovení ztracených finančních prostředků znovu použít stejnou aplikaci peněženky? {#if-i-lose-my-phonehardware-wallet-do-i-need-to-use-the-same-wallet-app-again-to-recover-the-lost-funds}
