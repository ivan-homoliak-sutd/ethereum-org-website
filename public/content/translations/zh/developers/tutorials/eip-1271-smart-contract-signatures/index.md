...
## EIP-1271 实现示例：安全 {#example-eip-1271-implementation-safe}
...
## `_hash` 参数到底是什么？ 为什么不传递整条消息？ {#what-exactly-is-the-hash-parameter-why-not-pass-the-whole-message}
...
### 先前的 EIP-1271 规范 {#previous-eip-1271-specifications}
...
## 如何在我的合约中实现 EIP-1271？ {#how-should-eip-1271-be-implemented-in-my-own-contracts}
