...
### 我可以在多个设备上使用相同的地址吗？ {#can-i-use-the-same-address-on-multiple-devices}

可以，你可以在多个设备上使用相同的地址。 技术上讲，你的钱包仅仅是用来显示余额以及执行交易的一个界面，你的帐户并不保存在你的钱包里，而是保存在区块链上。

### 我还没有收到应收的加密货币，在哪可以查看交易状态？ {#i-have-not-received-the-crypto-where-can-i-check-the-status-of-a-transaction}

你可以使用[区块浏览器](/developers/docs/data-and-analytics/block-explorers/)来实时查看任何交易的状态。 你仅需搜索你的钱包地址或交易 ID。

### 我可以取消或回滚交易吗？ {#can-i-cancel-or-return-transactions}
