...
# वॉलेट का उपयोग कैसे करें {#how-to-use-a-wallet}
...
## प्रोजेक्ट से जुड़ना {#connecting-to-projects}
...
### क्या एक ही पते का इस्तेमाल कई उपकरणों पर किया जा सकता है? {#can-i-use-the-same-address-on-multiple-devices}
...
### मुझे क्रिप्टो प्राप्त नहीं हुआ है, हम लेनदेन की स्थिति कहां देख सकते हैं? {#i-have-not-received-the-crypto-where-can-i-check-the-status-of-a-transaction}
...
### क्या मैं लेनदेन रद्द या वापस कर सकता हूँ? {#can-i-cancel-or-return-transactions}
