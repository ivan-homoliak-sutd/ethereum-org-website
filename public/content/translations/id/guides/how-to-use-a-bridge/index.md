...
# Cara menjembatani token ke layer 2 {#how-to-bridge-tokens-to-layer-2}
...
## 1. Tentukan jaringan layer 2 mana yang ingin Anda gunakan {#1-determine-which-layer-2-network-you-want-to-use}

Anda dapat mempelajari lebih lanjut tentang berbagai proyek dan tautan penting di [halaman layer 2](/layer-2/) kami.

## 2. Pergi ke jembatan yang dipilih {#2-go-to-the-selected-bridge}
...
## 7. Tambahkan jaringan layer 2 yang dipilih ke dompet Anda (opsional) {#7-add-the-selected-layer-2-network-to-your-wallet-optional}
